...
\begin{figure}[H] 
    ...
    \end{center}
    \caption[short]{Principio di funzionamento del meccanismo di obstacle avoidance.}
...
\begin{figure}[H] 
    ...
    \end{center}
    \caption[short]{Modello tridimensionale dell'impronta di feromone attrattivo.}
...
\begin{figure}[H] 
    ...
    \end{center}
    \caption[short]{Modello bidimensionale dell'impronta di feromone attrattivo.}
